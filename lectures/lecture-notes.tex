...
\begin{example}[A system with three variables]
  ...
  the plots of these three planes, if you want to play around with it.
  \begin{center}
  ...
  which case the system will have no solutions (credit Noah R. for the picture):
  \begin{center}
  ...
  in which case there are infinitely many solutions:
  \begin{center}
